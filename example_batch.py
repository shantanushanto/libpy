...
# Submit jobs for example_program.cpp
def example_program_cpp(cluster):
    # dir to save data in
    data_dir = 'data'
...
# Submit jobs for example_program.py
def example_program_py(cluster):
    # dir to save data in
    data_dir = 'data'
    data_dir = dir_choice(data_dir)  # dir checking

    # program to run
    exe = 'example_program.py'
...
def main():
    ...
    parser.add_argument("--which", choices=['example_program_py', 'example_program_cpp'], required=True, help="Which program to run.")
    # which cluster to use
    parser.add_argument("--cluster", choices=['palab', 'tamulauncher'], required=True, help="Cluster name.")
    args = parser.parse_args()

    # which program to run
    if args.which == 'example_program_py':
        example_program_py(args.cluster)
    elif args.which == 'example_program_cpp':
        example_program_cpp(args.cluster)
    else:
